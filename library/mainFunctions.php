...
function loadPage($smarty, $controllerName, $actionName = 'index'){
    ...
    include_once PathPrefix . $controllerName . PathPostfix; // PathPrefix = ../controllers/ , $controllerName = Index, PathPostfix = Controller.php
    // ../controllers/IndexController.php
    $function = $actionName . 'Action'; // $actionName = test
 ...
 */
function loadTemplate($smartys, $templateName)
{
    $smartys->display($templateName . TemplatePostfix);
}
 ...
 * Редирект
 * 
 * @param string $url адрес для перенапревления
 */
